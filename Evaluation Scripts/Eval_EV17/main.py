#Script for evaluating EV17 Predictions
...
parser.add_argument(
        ...
        required=False,
        type=str, 
        default= "/home/arnav/scratch/data_britty_mam/EndoVis_2017/fold3/annotations/instances_val_sub.json",
        help="GT annotations file name",
)
parser.add_argument(
        "--prediction_file",
        required=False,
        type=str,
        default = "/home/arnav/scratch/ISINET_evaluation/cleaned_code/output_jsons/ablations/base_ev17_folds/ev17_fold3_base.json",
...
parser.add_argument(
        ...
        required=False,
        type=str,
        default="Base_EV17_fold3_scores.txt",
...
BW_PATH = join(args.ground_truth_file.split('fold3')[0], 'semantic_annotations') #CMD for EV17, Change the fold number as per requirement
